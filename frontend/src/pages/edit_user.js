            ...
            <Header/>
                <section className="min-h-screen font-poppins mt-24">
                    <div className="flex flex-col justify-center items-center py-10">
                        <h2 className="mb-10 text-3xl font-bold font-poppins uppercase">Edit Data Obat</h2>
                            <div className="w-full flex justify-center">
                                <form className="flex flex-col gap-3 w-3/4" onSubmit={updateObat}>
                                    ...
                                    <div className="field flex flex-col gap-1">
                                        ...
                                        <div className="control">
                                            <input className={`min-h-14 block w-full rounded-md border-0 py-1.5 px-4 text-gray-900 ring-1 ring-inset ${errors.expired ? 'ring-danger' : 'ring-primari'} placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primari outline-none sm:text-sm sm:leading-6`} type="Date" value={expired} onChange={(e) => setExpired(e.target.value)} />
